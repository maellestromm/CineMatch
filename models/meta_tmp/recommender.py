...
class MetaRecommender:
    def __init__(self, db_path):
        ...
        self.models = {
            "SVD-50": SVDRecommender(db_path=self.db_path),
            "Item-KNN": ItemBasedRecommender(db_path=self.db_path, k_neighbors=7),
            "Deep-AutoRec": AutoRecRecommender(db_path=self.db_path),
            "Content-KNN": ContentBasedRecommender(db_path=self.db_path, k_neighbors=1),
            "User-KNN": UserBasedRecommender(db_path=self.db_path, k_neighbors=13)
        }
